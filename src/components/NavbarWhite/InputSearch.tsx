...
import Search from '../../assets/icons/Лупа темная.svg'
...
const SearchOpenForSmallScreen = () => (
  ...
  >
    <input
      placeholder="Поиск"
      className="w-[14rem] bg-secondary-400 font-geoItal text-[1.25rem] tracking-tight text-green-850 placeholder:text-green-850 focus:outline-none"
      type="text"
    />
    <Button>
...
const SearchFullScreen = () => (
  <div className="flex h-9 items-center justify-between gap-3 rounded-full border-[1px] border-green-850 bg-transparent px-4 py-2 ">
    <input
      className="h-5 w-20 bg-transparent font-geoItal text-base tracking-tight text-green-850 focus:outline-none"
      placeholder="Поиск"
    />
